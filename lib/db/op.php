...
class Op extends \OCA\OffiGimp\Db {

	const DB_TABLE = '`*PREFIX*offigimp_op`';
	
	protected $tableName = '`*PREFIX*offigimp_op`';
	
	protected $insertStatement = 'INSERT INTO `*PREFIX*offigimp_op` (`es_id`, `optype`, `member`, `opspec`) VALUES (?, ?, ?, ?)';
